...
{
    // as per https://developers.google.com/maps/documentation/javascript/markers
    ...
    ({
        position: newLatLng,
        map: map,
        title: place["place_name"] + ", " + place["admin_name1"] + ", " + place["country_code"],
        label: place["place_name"] + ", " + place["admin_name1"] + ", " + place["country_code"],
        icon: image
    });
    ...
    $.getJSON(Flask.url_for("articles"), {geo: place.postal_code}, function(articles) 
    {
        ...
        {			
            ...
            var articlesContent = "<b><p>" + place["place_name"] + ", " + place["admin_name1"] + " (" + place["postal_code"] + ")</b><ul>";
        ...
        google.maps.event.addListener(new_marker, 'click', function() {
            showInfo(new_marker, articlesContent);
		});
    });
